...
a.type="text/javascript",a.charset="utf-8",a.onreadystatechange=function(){("loaded"==a.readyState||"complete"==a.readyState)&&e()},a.onload=e,g.appendChild(a))};a&&(this.done=!1,this.load())},j,m={init:function(a,d,i){j||(j=l(void 0===a.autoload?!0:a.autoload));var c=b(this),g=b.extend({},q,a);n(function(){null===k&&("string"===typeof d&&"string"===typeof i)&&(k={appId:d,authenticationToken:i},e.util.ApplicationContext.set(k));var a=[],f;c.data("jovi",!0);g.behavior&&a.push(new e.map.component.Behavior);
